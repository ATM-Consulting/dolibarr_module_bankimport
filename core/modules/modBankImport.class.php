...
/**
 * 	\defgroup	bankimport	BankImport module
 * 	\brief		BankImport module descriptor.
 * 	\file		core/modules/modBankImport.class.php
 * 	\ingroup	bankimport
...
class modBankImport extends DolibarrModules
{
    ...
    public function __construct($db)
    {
        ...
        // (where XXX is value of numeric property 'numero' of module)
        $this->description = "Permet d'importer des fichiers bancaire csv pour rapprochement automatique";
        ...
        $this->picto = 'bankimport@bankimport'; // mypicto@bankimport
        // Defined all module parts (triggers, login, substitutions, menus, css, etc...)
        // for default path (eg: /bankimport/core/xxxxx) (0=disable, 1=enable)
        // for specific path of parts (eg: /bankimport/core/modules/barcode)
        // for specific css file (eg: /bankimport/css/bankimport.css.php)
        ...
        $this->config_page_url = array("admin_bankimport.php@bankimport");
        ...
        $this->langfiles = array("bankimport@bankimport"); // langfiles@bankimport
        // Constants
        ...
        $this->tabs = array(
            ...
            //	'objecttype:+tabname1:Title1:langfile@bankimport:$user->rights->bankimport->read:/bankimport/mynewtab1.php?id=__ID__',
            //	// To add another new tab identified by code tabname2
            //	'objecttype:+tabname2:Title2:langfile@bankimport:$user->rights->othermodule->read:/bankimport/mynewtab2.php?id=__ID__',
        ...
        /* Example:
          ...
          if (! isset($conf->bankimport->enabled)) $conf->bankimport->enabled=0;
          $this->dictionnaries=array(
        ...
        $this->boxes[$r][1] = "MyBox@bankimport";
        $r ++;
        /*
     ...
     * and create data commands must be stored in directory /bankimport/sql/
    ...
    {
        return $this->_load_tables('/bankimport/sql/');
    }
}